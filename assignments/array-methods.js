...
let fullName = [];
let allNames = runners.forEach(function(i) {
...
let ticketPriceTotal = runners.reduce((donationTotals, donationAmounts) => {
    return donationTotals + donationAmounts.donation;
}, 0);
